...
class SearchManagerFakeData @Inject constructor(
    ...
    override fun registerSearchEvent(userInfo: UserInfo) {
        ...
        scope.launch {
            ...
            delay(3000)
            currentRoom!!.updateUserStatus(randomUser.userUid,if (Random.nextBoolean()) UserStatus.IGNORE else UserStatus.ACCEPT)
        }
    }

    override fun updateUserStatus(userStatus: UserStatus) {
        currentRoom!!.updateUserStatus(currentUserInfo!!.userUid, userStatus)
    }
